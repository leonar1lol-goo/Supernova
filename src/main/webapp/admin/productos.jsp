...
<div class="admin-layout">
    ...
    <main class="admin-main">
        <div class="admin-container">
            <div class="admin-grid">
                <div class="admin-form users-panel">
                    ...
                    <div style="margin-top:12px">
                        <input id="productSearch" class="search-input" placeholder="Buscar productos (nombre, categoría, código)" />
                    </div>
                </div>
                ...
                <div class="admin-table table-scroll">
                    ...
                    <table id="productsTable" class="admin-table" style="margin-top:12px">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Nombre</th>
            ...
            <div id="createProductModal" class="modal-backdrop" style="display:none;align-items:center;justify-content:center;z-index:1200">
                <div class="modal" role="dialog" aria-modal="true" style="width:520px;max-width:calc(100% - 32px);padding:22px;border-radius:10px">
                    ...
                    <div class="register-container">
                        ...
                        <div class="actions" style="margin-top:14px">
                            ...
                            <button id="pcCreate" class="btn-save" style="background:#f97316;border:0;color:#fff;padding:10px 14px;border-radius:8px">Crear</button>
                        </div>
                    </div>
                </div>
            </div>

            <div id="editProductModal" class="modal-backdrop" style="display:none;align-items:center;justify-content:center;z-index:1200">
                <div class="modal" role="dialog" aria-modal="true" style="width:520px;max-width:calc(100% - 32px);padding:22px;border-radius:10px">
